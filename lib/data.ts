...
export const SERVICES = [
  {
    ...
    num: '01',
    icon: 'bot',
    title: 'Formation IA & Consulting',
    pitch: 'ChatGPT, Claude, Gemini, Make.com. Vos équipes maîtrisent l\'IA en 30 jours.',
    bullets: [
      'Formations ChatGPT & Claude (2-8h)',
      'Audit IA + plan d\'action 30/90 jours',
      'Ateliers Make.com & automatisations',
      'LinkedIn B2B boosté par l\'IA',
    ],
  ...
  },
  {
    ...
    num: '02',
    icon: 'chart',
    title: 'Directeur Marketing Externalisé',
    pitch: 'Stratégie + exécution mensuelle. Sans engagement long terme. €1500-5000/mois.',
    bullets: [
      'Stratégie marketing 360°',
      'SEO, contenu, réseaux sociaux',
      'Suivi KPI & reporting mensuel',
      'Sans engagement — résiliable à 30j',
    ],
